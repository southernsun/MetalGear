...
;20KM TO THE NORTH OF HERE.* METAL GEAR CAN BE DESTROYED IN ONLY ONE WAY.*
;ATTACH PLASTIC BOMB TO THE FOOT OF METAL GEAR.*
;R,R,L,R,L,L,R,L,L,R,R,L,R,L,R,...IN ORDER.*
;I FORGOT THE REMAINDER.* ANYWAY,* SET 16 UNITS.* YOU CAN NOT,DESTROY*IF YOU COMMIT AN ERROR IN THE ORDER.*
